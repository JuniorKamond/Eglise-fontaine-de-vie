...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-95",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 rounded-lg hover:-translate-y-px shadow-soft hover:shadow-elevated",
        ...
        hero: "bg-primary text-primary-foreground hover:bg-primary/90 rounded-full shadow-elevated hover:-translate-y-px hover:shadow-lg",
        heroOutline: "border border-primary-foreground/30 text-primary-foreground hover:bg-primary-foreground/10 rounded-full backdrop-blur-sm",
        gold: "bg-accent text-foreground font-semibold rounded-full hover:-translate-y-px shadow-soft hover:shadow-elevated",
      },
      size: {
